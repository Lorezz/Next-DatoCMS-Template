...
images {
  ...
  title
  tags
  url(imgixParams: {auto:format, maxW: "800",maxH: "600", fit:crop})
  responsiveImage(imgixParams: {auto:format, maxW: "800",maxH: "600", fit:crop}) {
    ...imgFrag
  }
}
`;
...
slides {
  ...
  id
    ...
    tags
    copyright
    url (imgixParams: { fit:crop, w:1280, h: 720, auto:format })
...
query post ($slug: String!) {
  post(filter: {slug: {eq: $slug}}) {
    ...
    pic {
      ...
      copyright
      title
      url(imgixParams: {auto:format, maxW: "400" })
...
query postList {
  posts: allPosts {
    ...
    pic {
      ...
      copyright
      title
      url(imgixParams: {auto:format, maxW: "400", q: "80"})
      responsiveImage (imgixParams: { auto:format, maxW: "400", q: "80"}){
        ...imgFrag
      }
    }
    author {
  ...
  page(filter: {slug: {eq: $slug}}) {
    ...
    pic {
      ...
      title
       ...
       responsiveImage(
          imgixParams: { fit:crop, w:1920, h:600, auto:format }
        ){
        ...imgFrag
       }
    }
